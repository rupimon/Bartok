...
// CBState includes both states for the game and to __ states for movement
public enum CBState{
	drawpile,
	toHand,
	hand,
...
public class CardBartok : Card {
	...
	//Fields to store info the card will use to smove and rotate
	...
	override public void OnMouseUpAsButton() {
		// Call the CardClicked methd on the Bartok Singleton
